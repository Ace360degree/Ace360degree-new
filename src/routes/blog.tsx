...
export const Route = createFileRoute("/blog")({
  ...
  head: () => ({
    // title:
    //   "Digital Marketing, AI & Business Growth Blog | Ace360degree",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Read the Ace360degree blog for expert insights on digital marketing, SEO, branding, AI, website development, business growth and industry trends.",
      },
      {
        name: "keywords",
        content:
      ...
      {
        property: "og:url",
        content: "https://www.ace360degree.com/blog",
      },
      {
    ...
    links: [
      {
        rel: "canonical",
        href: "https://www.ace360degree.com/blog",
      },
    ],
  }),
});

        ...
        <div className="mx-auto max-w-4xl px-6 py-24 text-center lg:py-28">
          ...
          <Reveal delay={240}>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link
                to="/portfolio"
                className="inline-flex items-center gap-2 rounded-2xl border border-white/16 bg-white/5 px-5 py-3 text-sm font-medium text-white shadow-sm transition-all duration-300 ease-out hover:bg-white/10 hover:shadow-[0_14px_34px_rgba(255,255,255,0.18)]"
              >
                View Case Studies
                <ArrowUpRight className="h-4 w-4" />
              </Link>

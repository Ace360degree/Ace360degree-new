  ...
  return (
    <div className="min-h-screen bg-canvas text-dark">
      ...
      <section className="py-24 md:py-32 bg-dark/[0.03]">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="font-serif text-4xl md:text-5xl max-w-3xl">
            The growth challenges we solve for D2C and retail brands.
          </h2>
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-[10px] uppercase tracking-[0.28em] text-brand font-semibold mb-4">
            D2C & Retail Brands We Support
          </div>
          <h2 className="font-serif text-4xl md:text-5xl max-w-3xl">
            Experience across modern consumer brands.
          </h2>
      ...
      <section className="py-24 md:py-32 bg-dark text-canvas">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-[10px] uppercase tracking-[0.28em] text-brand font-semibold mb-4">
            D2C Growth Framework
          </div>
          <h2 className="font-serif text-4xl md:text-5xl max-w-3xl">
            A five-stage operating model for modern consumer brands.
          </h2>
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="font-serif text-4xl md:text-5xl max-w-3xl">
            Four integrated capabilities. One commerce growth partner.
          </h2>
      ...
      <section className="py-24 bg-dark/[0.03]">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="font-serif text-4xl md:text-5xl">
            Helping brands grow through strategy, creativity and digital commerce.
          </h2>
          <p className="mt-4 text-dark/60">
            Active strategic partnerships across the retail and lifestyle space.
          </p>
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <Link
              to="/case-living-concepts"
              className="group border border-dark/10 p-8 bg-canvas hover:border-brand transition"
            >
              <div className="text-xs uppercase tracking-[0.22em] text-brand mb-3">
                Furniture & Interior Retail
              </div>
              <h3 className="font-serif text-2xl mb-2">Living Concepts</h3>
              <p className="text-dark/70 text-sm">
                Designing a premium digital experience for a luxury interior and furniture brand.
              </p>
            ...
            <div className="border border-dashed border-dark/15 p-8 bg-canvas/50 flex items-center justify-center text-center">
              <p className="text-dark/50 text-sm italic">
                Future D2C & Retail success stories are added here as our portfolio grows.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="font-serif text-4xl md:text-5xl max-w-3xl">
            Built for ambitious consumer brands.
          </h2>
      ...
      <section className="py-24 md:py-32 bg-dark text-canvas">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <h2 className="font-serif text-4xl md:text-6xl leading-tight">
            Ready to build a brand customers love and{" "}
            <span className="italic text-brand">products they keep buying?</span>
          </h2>
          <p className="mt-6 text-canvas/70 text-lg max-w-2xl mx-auto">
            Let's create a growth strategy that combines branding, digital commerce and performance
            marketing to increase sales, strengthen customer loyalty and accelerate long-term
            business growth.
          </p>
